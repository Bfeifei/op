	...
	<div class="">
		<el-row :gutter="20">
			<el-col :span="24">
				<div class="bg-nav">
					<div class="bg-left">
						<div class="grid-content bg-color">企业申请列表</div>
					</div>
					<div class="bg-right">
...
<script>
	import { enterCompanylist } from '@/api/api.js';
	...
	export default {
		...
		methods: {
			Operation(operation, index, Id) {
				...
				this.$router.push({
					path: '/publice/manage-apply/manage-details'
				})
			...
			getList() {
				this.loading = true
				enterCompanylist(this.listQuery)
					.then(res => {
						let {
							code,
							info,
