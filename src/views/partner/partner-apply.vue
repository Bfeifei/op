	...
	<div class="">
		<el-row :gutter="20">
			<el-col :span="24">
				<div class="bg-nav">
					<div class="bg-left">
						<div class="grid-content bg-color">城市合伙人申请列表</div>
					</div>
					<div class="bg-right">
			...
			<el-col :span="24">
				<div class="bg-table">
					<el-table v-loading="loading" element-loading-text="正在加载中" :data="list" border style="width: 100%">
						...
						<el-table-column prop="name" header-align="center" align="center" width="200" label="姓名">
						</el-table-column>
						...
						<el-table-column prop="created_at" header-align="center" align="center" label="申请时间">
						</el-table-column>
						...
						<el-table-column prop="operation" header-align="center" align="center" label="操作">
							<template slot-scope="scope">
								...
								<el-button type="text" @click="Del(scope.row.operation,scope.$index,scope.row.id)">删除</el-button>
							</template>
...
<script>
	import { enterCitylist } from '../../api/api.js';
...
//								});
			...
			Operation(operation, index, Id) {
				...
				this.$router.push({
					path: '/publice/partner-list/partner-details'
				})
